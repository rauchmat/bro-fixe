...
public class BroFixeContextSeed
{
    ...
    private static readonly Bro Eichi = new(nickname: "Eichi", email: "mario.eichinger86@gmail.com",
        avatarUrl: "assets/eichi.jpg");

    private static readonly Bro Hirschi = new(nickname: "Hirschi", email: "m.hirschbeck@gmx.net", avatarUrl: "assets/hirschi.jpg");
    ...
    private IEnumerable<Bro> GetPreconfiguredBros()
    {
        ...
        yield return new(nickname: "Mane", email: "manuel.schierl@gmail.com", avatarUrl: "assets/mane.jpg");
    ...
    {
        yield return new Fixe("Februar 2023", "Ebi", new DateTime(2022, 02, 23, 19, 0, 0),
        ...
        yield return new Fixe("Dezember 2022 - Weihnachtsfeier", "Addicted to Rock Bar & Burger", new DateTime(2022, 12, 22, 18, 0, 0),
            Mattl, backgroundUrl: "assets/harrys-augustin.jpg");
